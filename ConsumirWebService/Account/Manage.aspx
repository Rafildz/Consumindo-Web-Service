<%@ Page Title="Gerenciar conta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="ConsumirWebService.Account.Manage" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="confirmPassword"
                                    CssClass="text-error" Display="Dynamic" ErrorMessage="A senha e a senha de confirmação não coincidem."
                                    ValidationGroup="SetPassword" />
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        <h4>Alterar formulário da senha</h4>
                        <hr />
                        <asp:ValidationSummary runat="server" ShowModelStateErrors="true" CssClass="text-danger" />
                        <div class="form-group">
